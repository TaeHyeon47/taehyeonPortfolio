...
<html lang="en">
<head>
    <title>Code coverage report for lib/deps/migrate.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/deps/migrate.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/deps/</a> &#187; migrate.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">2226</span>
<span class="cline-any cline-yes">2226</span>
<span class="cline-any cline-yes">2225</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
  ...
  fs.unlink(base + '.uuid', function (err) {
    ...
    stores.forEach(function (store, i) {
      move(store, i, function (err, storePath) {
        /* istanbul ignore if */
        <span class="skip-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-skip" title="statement not covered" >          return callback(err);</span>
        }
        done.push(storePath);
        if (!(--todo)) {
      ...
      stores.bySeqStore.get(UPDATE_SEQ_KEY, function (err, value) {
        ...
        stores.docStore.createReadStream({
          ...
          Object.keys(ch.value.rev_map).forEach(function (key) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (key !== 'winner') {
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (deletedSeqs[seq]) {
<span class="cstat-no" title="statement not covered" >            return next();</span>
          ...
          stores.bySeqStore.get(seq, function (err, resp) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (err || !isLocalId(resp._id)) {
<span class="cstat-no" title="statement not covered" >              return next();</span>
            }
            batches.push({
              key: seq,
